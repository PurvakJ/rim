...
const Home = () => {
  ...
  // Features Data - Expanded to 6 features
  const RimFeatures = [
    ...
    { icon: "🎯", title: "Precision Engineering", description: "State-of-the-art manufacturing ensuring perfect fit and reliable performance." },
    { icon: "📊", title: "Smart Monitoring Ready", description: "Compatible with modern IoT-enabled monitoring systems for predictive maintenance." },
    { icon: "🌍", title: "Pan India Supply", description: "Fast and reliable delivery across India with dedicated logistics partner." }
  ];
        ...
        <div className="container">
          ...
          <div className="features-grid">
            {RimFeatures.map((feature, index) => (
              <div key={index} className="feature-card" ref={el => addToFeatureCards(el, index)}>
      ...
      <section className="featured-products">
        ...
        <div className="container">
          <div className="stats-grid">
            <div className="stat-item lazy-scale-up" ref={el => addToLazyRefs(el, 'lazy-scale-up')}>
